...
import works from "../data/works.json"; // keep it simple—no API layer
...
export default function ContinueReading() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-4">
      <Link
        to={`/work/${item.id}`}
        className="block rounded-xl border border-white/10 bg-white/5 p-3 hover:bg-white/7 transition"
      >
